...
_accountSid = '8aaf07086d62068d016d6c1de80c0a97'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = 'bcbf71d1a09f4f458991c0a5a9ce08ec'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '8aaf07086d62068d016d6c1de8610a9e'
...
if __name__ == '__main__':
    ...
    # 单例类发送短信验证码
    CCP().send_template_sms('15074355303', ['123456', 5], 1)
